	...
	<div class="container" style="width: 100%;padding: 25px 15px;">
		<div class="row clearfix">
			<div class="col-md-12 column" style="padding: 20px;padding-top: 0px;">
				<form action="${pageContext.request.contextPath}/userInfo/add/user.action" method="post" id="userForm" enctype="multipart/form-data" role="form" class="form-inline" style="margin-bottom: 10px;">
					<div class="form" style="padding:5px;">
								...
								<div class="form-group">
									...
									<select class="form-control" id="roleId" name="roleId">
										<c:forEach items="${roles }" var="r">
											<option value="${r.id }" <c:if test="${r.id == '4' }">selected="selected"</c:if>>${r.roleName }</option>
										</c:forEach>
									</select>
								</div>
							</div>
						...
						<div class="row rowDiv">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control inputText" id="entryTime" name="entryTime" placeholder="入职日期，如：2017-01-01">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									<input type="submit" class="btn btn-primary btn-sm" value="提交" onclick="return userAdd()"/>
								</div>
							</div>
						</div>
					</div>
